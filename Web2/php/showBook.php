	...
	public static function showBookk()
			...
			// -------------Sách Thiếu Nhi---------------------------------------------------------------------//
						...
						{		
							...
							{
								$page=$pageNum-1;
								$prev="<li><a href='".$sefl.$page."'>prev</a></li>";
								$first="<li><a href='".$sefl."1'>first</a></li>";
							}
							else
							{
								$prev="";
							...
							{
								$page=$pageNum+1;
								$next="<li><a href='".$sefl.$page."'>next</a></li>";
								$last="<li><a href='".$sefl.$maxPage."'>last</a></li>";
							}
							else
							{
								$next="";
						...
						{		
							...
							while($row=mysqli_fetch_array($result))
							{
								$s=$s. "<tr>"
										...
										."<td><a href='editBook.php?masach=".$row['MaSach']."'><i class='fa fa-trash fa-fw'></i> Xóa</a></td>"
									."</tr>";
								$i++;
							}
