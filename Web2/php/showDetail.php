													...
													.'<div id="buyandnumber">'
														...
														//.'<input type="hidden" name="theloai" value="'.$_GET['theloai'].'" >'
															.'<div class="input-group spinner" id="nhapso">'
																...
																.'</div>'
															.'</div>'
														.'<div><button id="button" class="btn btn-danger btn-lg m-t-22 m-l-5" onclick="addCart(`'.$MaSach.'`,document.getElementById(`soluong`).value);myFunction()">Chọn mua</button></div>'
													.'</div>'
													//.'</form>'
													.'<div class="intro">'
														.'<div class="block ">'
