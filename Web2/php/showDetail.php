													...
													.'<div id="buyandnumber">'
														...
														//.'<input type="hidden" name="theloai" value="'.$_GET['theloai'].'" >'
															.'<div class="input-group spinner" id="nhapso">'
																.'<input type="number" class="form-control" value="1" name="sl" id="soluong">'
																.'<div class="input-group-btn-vertical">'
																  .'<button class="btn btn-default" type="button"><i class="fa fa-caret-up"></i></button>'
																  .'<button class="btn btn-default" type="button"><i class="fa fa-caret-down"></i></button>'
																.'</div>'
															.'</div>'
														.'<div><button class="btn btn-danger btn-lg m-t-22 m-l-5" onclick="addCart(`'.$MaSach.'`,document.getElementById(`soluong`).value)">Chọn mua</button></div>'
													.'</div>'
													//.'</form>'
													.'<div class="intro">'
														.'<div class="block ">'
