	...
	<nav class="navbar navbar-inverse" style="margin-top:0px;border-radius:0px">
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="myNavbar2">
				...
				<ul class="nav navbar-nav navbar-right">
					<li>
						<a href="php/giohang.php"><span class="glyphicon glyphicon-shopping-cart"></span> Giỏ hàng <span class="badge badge-secondary" style="margin-bottom: 2px;"><?php echo $sl; ?></span></a>
					</li>
				</ul>
			</div>
